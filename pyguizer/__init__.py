...
class PyGUIzer:
    ...
    def run(cls, host="0.0.0.0", port=8000, title="PyGUIzer App"):
        ...
        """
        from pyguizer.api.app import PyGUIzerApp, create_app as create_fastapi_app
        import uvicorn
        ...
        for func in cls.registered_functions:
            ...
            pyguizer_app.register_function(func, pyguizer_instance.layout if pyguizer_instance else None)
        ...
        app.title = title
        app.description = f"Multi-function web application generated by PyGUIzer with {len(cls.registered_functions)} functions"
        
        # Run the server
        print(f"=== PyGUIzer Application ===")
