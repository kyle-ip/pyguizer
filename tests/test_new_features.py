...
from pyguizer.core.widget import generate_wso, register_widget_mapping, WidgetType
...
try:
    ...
    print(f"   ✅ Introspection successful! Found {len(func_info['parameters'])} parameters")
...
try:
    ...
    if custom_wsos[0]['type'] == WidgetType.TEXT:
        ...
        print(f"   ❌ Custom type mapping failed: Expected text, got {custom_wsos[0]['type']}")
