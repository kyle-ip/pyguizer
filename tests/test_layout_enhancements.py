...
def test_basic_section_layout():
    ...
    layout_config = {"sections": [{"name": "Main", "widgets": ["param1"]}]}
        ...
        "containers": [
            {
                "type": "grid",
                "rows": [
                    {"columns": [{"widgets": ["param1"]}, {"widgets": ["param2"]}]},
                    {"columns": [{"widgets": ["param3"]}, {"widgets": ["param4"]}]},
                ],
            }
        ]
    }
...
def test_inheritance_backward_compatibility():
    ...
    layout_config = {"sections": [{"name": "Old Style", "widgets": ["param1"]}]}
