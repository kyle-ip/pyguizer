...
class TestWidgetBasicTypes:
    ...
    def test_string_type(self):
        ...
        params = [{"name": "text", "type": str, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
    ...
    def test_int_type(self):
        ...
        params = [{"name": "count", "type": int, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_float_type(self):
        ...
        params = [{"name": "temperature", "type": float, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_bool_type(self):
        ...
        params = [{"name": "is_active", "type": bool, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_optional_type(self):
        ...
        params = [{"name": "value", "type": Optional[int], "default": None, "required": False, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
...
class TestWidgetComplexTypes:
    ...
    def test_list_str_type(self):
        ...
        params = [{"name": "items", "type": List[str], "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_list_other_type(self):
        ...
        params = [{"name": "numbers", "type": List[int], "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_dict_type(self):
        ...
        params = [{"name": "config", "type": Dict[str, Any], "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_set_str_type(self):
        ...
        params = [{"name": "tags", "type": Set[str], "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_tuple_type(self):
        ...
        params = [{"name": "coordinates", "type": Tuple[int, int], "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_frozenset_type(self):
        ...
        params = [{"name": "immutable_set", "type": FrozenSet[str], "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
...
class TestWidgetSpecialTypes:
    ...
    def test_path_type(self):
        ...
        params = [{"name": "file_path", "type": Path, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_date_type(self):
        ...
        params = [{"name": "birth_date", "type": date, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_time_type(self):
        ...
        params = [{"name": "meeting_time", "type": time, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_datetime_type(self):
        ...
        params = [{"name": "event_time", "type": datetime, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_decimal_type(self):
        ...
        params = [{"name": "price", "type": Decimal, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_uuid_type(self):
        ...
        params = [{"name": "user_id", "type": UUID, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_enum_type(self):
        ...
        params = [{"name": "color", "type": Color, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
...
class TestWidgetWSOGeneration:
    ...
    def test_multiple_parameters(self):
        ...
        params = [
            {"name": "name", "type": str, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"},
            {"name": "age", "type": int, "default": 25, "required": False, "kind": "POSITIONAL_OR_KEYWORD"},
            {"name": "active", "type": bool, "default": True, "required": False, "kind": "POSITIONAL_OR_KEYWORD"}
        ]
        wsos = generate_wso(params)
    ...
    def test_label_generation(self):
        ...
        params = [{"name": "user_name", "type": str, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_data_type_preservation(self):
        ...
        params = [{"name": "value", "type": List[str], "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
...
class TestWidgetRegistry:
    ...
    def test_register_inheritance_mapping(self):
        ...
        WIDGET_REGISTRY["inheritance"] = [
            item for item in WIDGET_REGISTRY["inheritance"]
            if item[1] != BaseType
        ]
...
class TestWidgetEdgeCases:
    ...
    def test_any_type(self):
        ...
        params = [{"name": "dynamic", "type": Any, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
    ...
    def test_dataclass_type(self):
        ...
        params = [{"name": "user", "type": User, "default": None, "required": True, "kind": "POSITIONAL_OR_KEYWORD"}]
        wsos = generate_wso(params)
